// =============================================================================
// Reset all static animation/effect state variables
void resetAllStateVars() {
  // Inactive state
  extern uint32_t doStateInactive_nextSparkMs;
  doStateInactive_nextSparkMs = 0;

  // Boot state
  extern uint32_t doStateBoot_stateEnteredMs, doStateBoot_nextSparkMs, doStateBoot_nextChaseMs, doStateBoot_nextServoMs;
  extern bool doStateBoot_pincersRigid, doStateBoot_servo1Active, doStateBoot_servoLimp, doStateBoot_cyanPulsePhase;
  extern int8_t doStateBoot_servoDir;
  extern uint8_t doStateBoot_servoAngle;
  doStateBoot_stateEnteredMs = 0;
  doStateBoot_nextSparkMs = 0;
  doStateBoot_nextChaseMs = 0;
  doStateBoot_nextServoMs = 0;
  doStateBoot_pincersRigid = false;
  doStateBoot_servo1Active = false;
  doStateBoot_servoLimp = false;
  doStateBoot_servoDir = 1;
  doStateBoot_servoAngle = 22;
  doStateBoot_cyanPulsePhase = true;

  // Demo state
  extern uint32_t doStateDemo_stateEnteredMs, doStateDemo_nextSparkMs, doStateDemo_nextChaseMs, doStateDemo_nextServoMs;
  extern bool doStateDemo_pincersRigid;
  extern int8_t doStateDemo_servoDir0, doStateDemo_servoDir1;
  extern uint8_t doStateDemo_servoAngle0, doStateDemo_servoAngle1;
  doStateDemo_stateEnteredMs = 0;
  doStateDemo_nextSparkMs = 0;
  doStateDemo_nextChaseMs = 0;
  doStateDemo_nextServoMs = 0;
  doStateDemo_pincersRigid = false;
  doStateDemo_servoDir0 = 1;
  doStateDemo_servoDir1 = -1;
  doStateDemo_servoAngle0 = 22;
  doStateDemo_servoAngle1 = 120;

  // Failure state
  extern uint32_t doStateFailure_stateEnteredMs, doStateFailure_nextSparkMs, doStateFailure_nextServoMs;
  doStateFailure_stateEnteredMs = 0;
  doStateFailure_nextSparkMs = 0;
  doStateFailure_nextServoMs = 0;

  // NeoPixel chase
  extern uint16_t chase_head;
  extern uint32_t chase_nextMs;
  chase_head = 0;
  chase_nextMs = 0;
}
// =============================================================================
...
void doStateInactive() {
  ...
  // Reset all animation/effect state variables when entering sequence 0
  resetAllStateVars();
  uint32_t now = millis();
