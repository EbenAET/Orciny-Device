...
static constexpr uint8_t kPreviousSwitchPin = A2;  // GP28
static constexpr uint8_t kNextSwitchPin = A3;      // GP29

// Prop-Maker FeatherWing MOSFET LED outputs for high-power lighting.
// GP10 (D10) is the Prop-Maker PWR enable pin and must be held high.
