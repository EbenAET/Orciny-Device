...
| 3 | H-CORE | 3-pin JST HX (NeoPixel side); splits from same 4-pin cable as H-BAT-NEO | RP2040 GP11, +3V7_NEO, GND_COMMON | NeoPixel strip DI, +V, GND | Pin 1 red=+V, pin 2 white=signal, pin 3 black+brown=GND; cap across pins 1-3 |
| 4 | H-SW | 4-pin JST | SW1/SW2/SW3, GND | RP2040 GP2/GP3/GP4, GND | Pin 1 blue=SW1, pin 2 brown=SW2, pin 3 orange=SW3, pin 4 green=GND |
| 5 | H-SPARK | 5-pin DMX cable | RP2040 GP5/GP6/GP9/GP10, GND | Spark channels 1-4 (+ spare) | green=GND; pin 1 red=SP1, pin 2 brown=SP2, pin 3 white=SP3, pin 4 blue=SP4, pin 5 black=spare |
...
| 7 | H-BEAM-PWR | 4-pin JST (common anode RGB LED) | +5V_BUS, GND_COMMON | Beam load path | Pin 1 white=anode, pin 2 red=R(GP12), pin 3 blue=B(GP14), pin 4 green=G(GP13) |
